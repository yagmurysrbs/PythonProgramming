...
dir(str) #str ile kullanılabilecek  metodlar gelir
dir(int)
...
#type(upper) çalışmazlar çünkü  method
# type(upper())
...
# içinde sayı ,bool, ve liste olan bir liste tanımlandı
...
dir(notes) #notes adındaki listeye uygulanabilecek methodlar
...
# key-value çifteli ile kulllanılır
#anahtar -değer
...
#key karşısına listelerde girilebilir
...
#######################
dictionary.keys()
#tanımlanan sözlükte tüm keyler gelir
...
dictionary.values()
#tanımlanan sözlükte tüm valular gelir
...
dictionary.items()
#key ve valuları tupple(demet) cinsinden verir
#######################
...
# - Değiştirilemez.
# - Sıralıdır.(veri yapısının elamanlarına erişilebiliyor)
# - Kapsayıcıdır.(birden farklı veri yapısını tutabilir)
...
t[0] = 99
#tupple elemanı değiştiremez

t = list(t)
t[0] = 99
t = tuple(t)
#tupple listeye çevirdik
#atama yaptık ve tekrar tupple çevirdik
...
set1 = set([1, 3, 5])
#liste üzerinden bir set oluşturulur
set2 = set([1, 2, 3])

# set1'de olup set2'de olmayanlar.
set1.difference(set2)
set1 - set2
#matematiksel ifade ilede methodun görevini yaparız
